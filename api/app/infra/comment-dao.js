        ...
        return new Promise((resolve, reject) => {
            this._db.run(`
                ...
                function (err) {
                    if (err) {
                        console.log(err);
                        return reject('comment-dao.js - Não foi possível adicionar um comentário!');
                    }
                    resolve(this.lastID);
                });
        });
        ...
        return new Promise((resolve, reject) => {
            this._db.all(
                ...
                (err, rows) => {
                    ...
                    if (err) {
                        console.log(err);
                        return reject('comment-dao.js - Não será possível carregar comentário!');
                    }
        ...
        return new Promise((resolve, reject) => {
            this._db.get(
                ...
                (err, row) => {
                    ...
                    if (err) {
                        console.log(err);
                        return reject('comment-dao.js - Não foi possível carregar comentários!');
                    }
